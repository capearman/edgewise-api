...
def test_get_one_transaction_successful(client, test_categories, test_transactions):
    result = client.get(f"/transactions/{test_transactions[0].id}")

    assert result.status_code == 200

def test_get_one_transaction_id(client, test_categories, test_transactions):
    result = client.get(f"/transactions/{test_transactions[0].id}")
    transaction = schemas.Transaction(**result.json())

    assert transaction.id == test_transactions[0].id

def test_get_one_transaction_type(client, test_categories, test_transactions):
    result = client.get(f"/transactions/{test_transactions[0].id}")
    transaction = schemas.Transaction(**result.json())

    assert transaction.type == test_transactions[0].type

def test_get_one_transaction_date(client, test_categories, test_transactions):
    result = client.get(f"/transactions/{test_transactions[0].id}")
    transaction = schemas.Transaction(**result.json())

    assert transaction.date == test_transactions[0].date

def test_get_one_transaction_amount(client, test_categories, test_transactions):
    result = client.get(f"/transactions/{test_transactions[0].id}")
    transaction = schemas.Transaction(**result.json())

    assert transaction.amount == test_transactions[0].amount

def test_get_one_transaction_description(client, test_categories, test_transactions):
    result = client.get(f"/transactions/{test_transactions[0].id}")
    transaction = schemas.Transaction(**result.json())

    assert transaction.description == test_transactions[0].description

def test_get_one_transaction_category(client, test_categories, test_transactions):
    result = client.get(f"/transactions/{test_transactions[0].id}")
    transaction = schemas.Transaction(**result.json())
...
def test_get_all_transactions(client, test_categories, test_transactions):
...
def test_create_transaction_successful(client, test_categories, type, date, amount, description, category, check_box):
...
@pytest.mark.parametrize(create_transaction_test_fields, create_transaction_test_data)
def test_create_transaction_type(client, test_categories, type, date, amount, description, category, check_box):
    result = client.post("/transactions/", json={"type":type, "date":date, "amount":amount, "description":description, "category":category, "check_box":check_box})
...
@pytest.mark.parametrize(create_transaction_test_fields, create_transaction_test_data)
def test_create_transaction_date(client, test_categories, type, date, amount, description, category, check_box):
    result = client.post("/transactions/", json={"type":type, "date":date, "amount":amount, "description":description, "category":category, "check_box":check_box})
    created_transaction = schemas.TransactionCreateOut(**result.json())
...
@pytest.mark.parametrize(create_transaction_test_fields, create_transaction_test_data)
def test_create_transaction_amount(client, test_categories, type, date, amount, description, category, check_box):
    result = client.post("/transactions/", json={"type":type, "date":date, "amount":amount, "description":description, "category":category, "check_box":check_box})
    created_transaction = schemas.TransactionCreateOut(**result.json())
...
@pytest.mark.parametrize(create_transaction_test_fields, create_transaction_test_data)
def test_create_transaction_description(client, test_categories, type, date, amount, description, category, check_box):
    result = client.post("/transactions/", json={"type":type, "date":date, "amount":amount, "description":description, "category":category, "check_box":check_box})
    created_transaction = schemas.TransactionCreateOut(**result.json())
...
@pytest.mark.parametrize(create_transaction_test_fields, create_transaction_test_data)
def test_create_transaction_category(client, test_categories, type, date, amount, description, category, check_box):
    result = client.post("/transactions/", json={"type":type, "date":date, "amount":amount, "description":description, "category":category, "check_box":check_box})
    created_transaction = schemas.TransactionCreateOut(**result.json())
...
@pytest.mark.parametrize(create_transaction_test_fields, create_transaction_test_data)
def test_create_transaction_check_box(client, test_categories, type, date, amount, description, category, check_box):
    result = client.post("/transactions/", json={"type":type, "date":date, "amount":amount, "description":description, "category":category, "check_box":check_box})
    created_transaction = schemas.TransactionCreateOut(**result.json())

    assert created_transaction.check_box == check_box

def test_delete_transaction_success(client, test_categories, test_transactions):
...
def test_update_transaction_success(client, test_categories, test_transactions):
...
def test_update_transaction_type(client, test_categories, test_transactions):
...
def test_update_transaction_date(client, test_categories, test_transactions):
...
def test_update_transaction_amount(client, test_categories, test_transactions):
...
def test_update_transaction_description(client, test_categories, test_transactions):
...
def test_update_transaction_category(client, test_categories, test_transactions):
...
def test_update_transaction_check_box(client, test_categories, test_transactions):
...
def test_update_transaction_non_exist(client, test_categories, test_transactions):
    result = client.put("/transactions/99999999",json=update_transaction_test_data)

    assert result.status_code == 404   

def test_update_id(client, test_categories, test_transactions):
    data = {
        "id": 99,
        "type": "Expense",
        "date": "2022-06-07",
...
def test_update_category_id(client, test_categories, test_transactions):
    data = {
        "id": 3,
        "type": "Expense",
        "date": "2022-06-07",
