...
def test_delete_category_non_exist(client):
    result = client.delete("/categories/9999999999")
    assert result.status_code == 404

def test_update_category_success(client, test_headers, test_categories, test_transactions):
